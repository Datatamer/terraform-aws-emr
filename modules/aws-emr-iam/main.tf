/*
The following module creates 5 resources to be used by EMR Hbase:
- A minimal IAM policy that will be used by the service role for EMR
- An IAM role for EMR service role
- A minimal IAM policy that will be used by the instance profile for EC2 in EMR
- An IAM role for instance profile for EMR EC2 instances
- An IAM instance profile for EMR EC2 instances

References:
Default policies for EMR: https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-iam-roles.html
Service role policy for EMR: https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-iam-role.html
Instance profile policy for EMR: https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-iam-role-for-ec2.html
