...
module "ephemeral-spark-sgs" {
  # source              = "git::git@github.com:Datatamer/terraform-aws-emr.git//modules/aws-emr-sgs?ref=7.2.1"
...
module "ephemeral-spark-iam" {
  # source                            = "git::git@github.com:Datatamer/terraform-aws-emr.git//modules/aws-emr-iam?ref=7.2.1"
...
module "ephemeral-spark-config" {
  # source                        = "git::git@github.com:Datatamer/terraform-aws-emr.git//modules/aws-emr-config?ref=7.2.1"
