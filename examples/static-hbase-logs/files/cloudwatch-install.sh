...
echo " {
    \"logs\": {
            \"endpoint_override\": \"vpce-05da4aa745d11fd29-hjeao3t3.logs.us-east-2.vpce.amazonaws.com\",
      \"logs_collected\": {
             \"files\": {
                 \"collect_list\": [
                     {
                         \"file_path\": \"/emr/instance-controller/log/bootstrap-actions/**.log\",
                         \"log_group_name\": \"poc-cw-without-vpc-tamr_log_group\",
                     ...
                     },
                     {
                         ...
                         \"log_group_name\": \"poc-cw-without-vpc-tamr_log_group\",
                         \"log_stream_name\": \"$id-hadoop-steps\",
                         \"timestamp_format\": \"%H: %M: %S%y%b%-d\"
                     },
                     {
