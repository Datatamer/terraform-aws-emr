locals {
  tags      = { "myTestTagKey" : "myTestTagValue" }
  abac_tags = { "tamr.com/role" : "emr" }
}
...
module "emr-hbase" {
  # source = "git::git@github.com:Datatamer/terraform-aws-emr.git?ref=4.1.0"
  source = "../.."
  ...
  applications                  = ["Hbase"]
  emr_config_file_path          = "../../examples/emr-config-template.json"
